...
const sphereGeometry = new THREE.SphereGeometry(undefined, 10)
...
function animate() {
    ...
    icosahedron.rotation.y += 0.013
    plane.rotation.y += 0.013
    torusKnot.rotation.y += 0.013
    sphere.rotation.x += 0.013
    cube.rotation.x += 0.013
    icosahedron.rotation.x += 0.013
    plane.rotation.x += 0.013
    torusKnot.rotation.x += 0.013
